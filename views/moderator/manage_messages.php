...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($action == 'mark_in_progress') {
        $query = "UPDATE contact_messages SET status='in-progress', assigned_to=$moderator_id 
    ...
    if ($action == 'mark_resolved') {
        $query = "UPDATE contact_messages SET status='resolved', resolved_by=$moderator_id, 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($action == 'reply_message') {
        ...
        $query = "UPDATE contact_messages SET admin_reply='$admin_reply', status='$new_status', 
                  assigned_to=$moderator_id WHERE message_id=$message_id";
    ...
    if ($action == 'change_status') {
        ...
        if ($new_status == 'in-progress') {
            $update_fields .= ", assigned_to=$moderator_id";
        } elseif ($new_status == 'resolved') {
            $update_fields .= ", resolved_by=$moderator_id, resolved_at=NOW()";
        }
...
<head>
    ...
    <title>Manage Messages - ScamShield Moderator</title>
        ...
        <div class="admin-content">
            ...
            <main class="dashboard-main">
                ...
                <div class="section-card">
                    ...
                    <p class="info-text">Note: Moderators cannot delete messages. Contact an admin for deletions.</p>
