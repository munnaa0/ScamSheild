...
<head>
    ...
    <title>Manage Blog Posts - ScamShield Admin</title>
                ...
                <div class="section-card">
                    ...
                    <div class="post-meta">
                        <span class="meta-item">
                            ...
                            <?php 
                            $author_name = $view_post['first_name'] ? 
                                          $view_post['first_name'] . ' ' . $view_post['last_name'] : 
                                          $view_post['username'];
                            echo htmlspecialchars($author_name); 
                            ?>
                        </span>
                        <span class="meta-item">
                            ...
                            <span class="category-tag"><?php echo htmlspecialchars($view_post['category']); ?></span>
                        </span>
                        <span class="meta-item">
                            <strong>Posted:</strong> <?php echo date('M d, Y H:i', strtotime($view_post['created_at'])); ?>
                        </span>
                        <?php if ($view_post['updated_at'] != $view_post['created_at']): ?>
                        <span class="meta-item">
                            <strong>Updated:</strong> <?php echo date('M d, Y H:i', strtotime($view_post['updated_at'])); ?>
                        </span>
                        <?php endif; ?>
                    </div>
                    <div class="post-content">
                        <?php echo nl2br(htmlspecialchars($view_post['content'])); ?>
                    </div>
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="category-tag"><?php echo htmlspecialchars($post['category']); ?></span></td>
